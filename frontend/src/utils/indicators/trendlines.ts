  ...
  implements ConfigurableIndicator
{
  ...
  setParameters(params: Record<string, any>): void {
    ...
    if (params.pivotOpacity !== undefined)
      this.pivotOpacity = params.pivotOpacity;
    if (params.projectionOpacity !== undefined)
      this.projectionOpacity = params.projectionOpacity;
    this.calculate();
  }
