...
import type { IndicatorParameter } from "@/utils/indicators/base/configurable-indicator";
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Adjust the parameters for this indicator.
          </DialogDescription>
        </DialogHeader>
              ...
              {param.type === "number" ? (
                ...
                <div className="col-span-3 flex items-center gap-2">
                  <div
                    ...
                    style={{
                      backgroundColor:
                        config[param.name] || param.value || "#000000",
                    }}
                  />
                  <Input
                    id={param.name}
