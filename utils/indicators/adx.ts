...
export class ADXIndicator extends Indicator implements ConfigurableIndicator {
  static readonly name = "ADX/DI"
  static readonly config = {
    subplot: true,
    height: 0.3, // 30% of the chart height
  }
  static readonly defaultParams: IndicatorParameter[] = [
    { name: "period", type: "number", label: "Period", value: 14, min: 1, max: 50, step: 1 },
    { name: "adxColor", type: "string", label: "ADX Line Color", value: "rgb(234, 179, 8)" }, // Amber
    { name: "plusDIColor", type: "string", label: "DI+ Color", value: "rgb(34, 197, 94)" }, // Green
    { name: "minusDIColor", type: "string", label: "DI- Color", value: "rgb(239, 68, 68)" }, // Red
    { name: "strongTrend", type: "number", label: "Strong Trend Level", value: 25, min: 0, max: 100, step: 1 },
  ]
