...
export class BollingerBandsIndicator extends Indicator implements ConfigurableIndicator {
  static readonly name = "Bollinger Bands"
  static readonly defaultParams: IndicatorParameter[] = [
    { name: "period", type: "number", label: "Period", value: 20, min: 1, max: 100, step: 1 },
    { name: "stdDev", type: "number", label: "Standard Deviations", value: 2, min: 0.1, max: 5, step: 0.1 },
    { name: "middleColor", type: "string", label: "Middle Band Color", value: "rgb(59, 130, 246)" }, // Blue
    { name: "bandColor", type: "string", label: "Bands Color", value: "rgb(147, 51, 234)" }, // Purple
    { name: "bandOpacity", type: "number", label: "Bands Opacity", value: 0.1, min: 0, max: 1, step: 0.1 },
  ]
  ...
  private calculateStandardDeviation(prices: number[], sma: (number | null)[]): (number | null)[] {
